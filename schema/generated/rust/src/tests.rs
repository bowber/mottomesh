...
fn test_inner_data_roundtrip() {
    ...
    assert_eq!(encoded[0], PROTOCOL_VERSION_BYTE, "First byte should be version byte");
...
fn test_schema_router_tag_values() {
    ...
    assert_eq!(SchemaRouter::INNER_DATA_TAG, 0, "Tag for InnerData should be 0");
    assert_eq!(SchemaRouter::TEST_DATA_TAG, 1, "Tag for TestData should be 1");
    assert_eq!(SchemaRouter::CLIENT_ENVELOPE_TAG, 2, "Tag for ClientEnvelope should be 2");
    assert_eq!(SchemaRouter::SERVER_ENVELOPE_TAG, 3, "Tag for ServerEnvelope should be 3");
}
